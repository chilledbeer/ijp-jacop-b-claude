**JACoP by F. Cordelières – Refurbished Version with a Compact GUI**

This is a modified version of the JACoP plugin originally developed by F. Cordelières and later revamped by BIOP. The graphical user interface (GUI) has been redesigned to be more compact, making it easier to use on laptops with smaller screens.
